...
READY_IDEA_ITEMS: dict[str, list[tuple[str, str, str, int]]] = {
    ...
    "celebrities": [
        ...
        (
            ...
            "Ultra-realistic 9:16 vertical iPhone selfie photo, wide-angle front camera, taken by the user, behind-the-scenes movie set photography style, natural daylight mixed with set lights, cinematic atmosphere, high dynamic range, true-to-life colors. SELFIE CAMERA LOCK: this image must look exactly like the final front-camera photo from the user's phone, not a third-person shot. Camera POV is the phone in the user's hand at arm's length. Do NOT show an external photographer, do NOT show the full phone body in frame (at most a tiny edge/hand reflection allowed), and keep classic front-camera perspective distortion. CRITICAL IDENTITY LOCK: use the attached user photo as the exact face reference for the person holding the phone (ME in the middle): same facial features, skin texture, haircut, proportions — no beautification, no face replacement. LOCATION: busy behind-the-scenes film set — camera rigs, lighting stands, director chairs, crew, cables, monitors, trailers blurred in background, green screen or stage elements optional. SCENE — friendly backstage selfie, three people close together: LEFT: Homelander from the series The Boys — iconic patriotic superhero suit with cape, realistic fabric and emblem details, mask removed; confident heroic look, blonde hair, natural skin. CENTER: ME holding the smartphone with one hand, smiling confidently, natural selfie posture. RIGHT: Billy Butcher from The Boys — Karl Urban lookalike: stubble beard, weathered face, dark trench coat / leather jacket, casual tough styling, relaxed smirk, mask off. All three laughing or smiling naturally, relaxed teamwork vibe. CLOTHING: Homelander full hero suit; Butcher as described. ME (user) wardrobe — infer gender presentation from the reference photo: if male-presenting, elegant classic suit, white shirt, dark trousers, leather shoes; if female-presenting, smart casual women's outfit suitable for a film set (e.g. blouse or shirt, skirt or tailored trousers, light jacket optional), cohesive colors, no cocktail glam unless it fits the face reference — never force a male suit on a woman or vice versa. PHOTOGRAPHY: Shot on iPhone 15 Pro Max look, HDR, high resolution, realistic skin texture, soft shadows, shallow depth of field, no beauty filters, no AI gloss. MOOD: fun Hollywood backstage moment, gritty-superhero show vibe, authentic. NEGATIVE: third-person camera angle, external camera view, visible full phone in hand, blur, distortion, extra fingers, cartoon, plastic skin, fake HDR halos, wrong faces, masks covering Homelander or Butcher faces, duplicate arms, watermark, Telegram username text.",
            1,
        ),
    ],
    "for_two": [
