...
_READY_LIMITS_FAQ_BODY = (
    ...
    "При активной подписке лимита по «Готовым идеям» нет.\n\n"
    ...
    "(то же время суток по UTC). Дополнительно: +1 запуск «Готовых идей» за каждых 2 приглашённых друзей по /ref."
)
...
_CREDITS_FAQ_BODY = (
    ...
    "при подписке лимита нет, без подписки действует отдельный цикл.\n"
